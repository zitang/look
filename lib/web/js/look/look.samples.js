var Look = (function () {
    ...
    this.Samples.add = function (buffer) {
        ...
        buffer.forEach(function (sample) {
            ...
            if (sample._label) {
                sample._label = decodeURI(sample._label);
            }
            if (sample.URL) {
                sample.URL = decodeURI(sample.URL);
            }

            if (contextSample.lastSample && sample.URL === contextSample.lastSample.URL && sample._end === contextSample.lastSample._end) {
                return;
            } else {
                if (sample.Error) {
                    // errors
