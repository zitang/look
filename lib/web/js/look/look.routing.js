var Look = (function () {
    ...
    var LookRouter = Backbone.Router.extend({
        ...
        transactionsPage: function () {
            that.Router.go('transactions', true)
        },
        metricsPage: function () {
            that.Router.go('metrics', true)
        },
        cpuPage: function () {
            that.Router.go('cpu', true)
        },
        memoryPage: function () {
            that.Router.go('memory', true)
        }
    });
    ...
    this.Router.go = function (page, notNavigate) {
        if (!notNavigate) {
            that.Router.router.navigate(page);
        }
